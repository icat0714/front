  ...
  <div>
    ...
    <el-form :inline="true" class="demo-form-inline" style="margin-top: 20px;margin-left: 30px;">
      ...
      <el-form-item label="开单人姓名:">
        <el-input v-model="drawername" placeholder="请输入开单人姓名"></el-input>
      </el-form-item>
      <el-form-item>
      ...
      <el-table :data="data1" style=" margin-top:10px;width: 100%;" :border="true" max-height="550">
        ...
        <el-table-column prop="warehouseno" label="入库单号" min-width="50" align="center"></el-table-column>
        ...
        <el-table-column prop="drawertime" label="开单时间" min-width="80" align="center"></el-table-column>
    ...
    <el-dialog title="货物修改" style="width: 1400px;" :visible.sync="dialogFormVisible1" @close="cleanForm">
      <el-form :model="stockFrom" ref="stockFrom" >
            <el-form-item label="入库单号" prop="warehouseno" :label-width="formLabelWidth" v-if="show">
    ...
    <el-dialog title="查看明细" style="width: 1750px;margin-top:100px;" :visible.sync="dialogFormVisible2">
        ...
        <el-table :data="data2" style=" margin-top:10px;width: 100%;" :border="true" max-height="550">
          ...
          <el-table-column prop="warehouseno" label="入库单号" min-width="68" align="center" v-if="show"></el-table-column>
          ...
          <el-table-column prop="storagenum" label="入库数量" min-width="68" align="center"></el-table-column>
          <el-table-column prop="actualnum" label="实际数量" min-width="68" align="center"></el-table-column>
  ...
  export default {
    ...
    methods:{
      ...
      handleEdit: function(row) {
        ...
        this.stockFrom.drawerno=row.drawerno;
        this.stockFrom.drawername=row.drawername;
        this.stockFrom.subordinateunit=row.subordinateunit;
        this.stockFrom.transport=row.transport;
      },
      //删除
      handleDelete: function(row) {
          let params={ WAREHOUSENO:row.warehouseno}
      ...
      doSubmit1:function(){
        this.$refs['stockFrom'].validate((valid) => {
          if (valid) {
            let url = 'http://localhost/Stock/updateStock';
            let params = {
      ...
      doSubmit5: function() {
          ...
          if (this.warehouseno == null && this.reservoirtype == null && this.transport == null ) {
            this.findAll();
          }
          ...
          if (this.drawername != null && this.drawername != "") {
            this.data1 = this.data1.filter(a => a.drawername.indexOf(this.drawername) != -1);
          }
